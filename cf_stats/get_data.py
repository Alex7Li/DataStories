...
def get_contest_standings():
    ...
    if os.path.exists(metadata_path):
        ...
        contest_metadata = {}
    for contest_id in tqdm(range(1, 1790)):
        if contest_id in [179, 184, 210, 307, 310, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399,
                          410, 422, 423, 428, 473, 481, 502, 503, 511, 517, 539, 589, 619, 654, 692,
                          693, 694, 726, 728, 783, 824, 826, 829, 836, 857, 874, 880, 881, 882, 885,
                          905, 941, 942, 943, 945, 968, 969, 970, 971, 972, 973, 974, 1018, 1021,
                          1022, 1024, 1026, 1035, 1048, 1049, 1050, 1069, 1094, 1122, 1123, 1124,
                          1125, 1126, 1127, 1128, 1134, 1135, 1222, 1224, 1226, 1232, 1233, 1258,
